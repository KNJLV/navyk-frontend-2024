...
let teacherPhoto = ["TEACHER-PHOTO-1.png", "___", "TEACHER-PHOTO-2.png"];

// массив фамилий преподавателей
let teacherSurname = ["СУХОВ", "___", "ШУЛЬМИНА"];

// массив имён преподавателей
let teacherName = ["Владислав Сергеевич", "___ ___", "Ксения Владимирова"];
