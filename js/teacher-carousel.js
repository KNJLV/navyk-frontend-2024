...
let teacherSurname = ["СУХОВ", "СЕРГЕЕВА", "ШУЛЬМИНА"];

// массив имён преподавателей
let teacherName = ["Владислав Сергеевич", "Анна Витальевна", "Ксения Владимировна"];
...
let teacherDesc = [
  ...
  " многократный победитель регионального этапа ВсОШ по русскому языку, английскому языку и литературе",
  " победитель перечневых олимпиад по русскому и английскому языкам",
  " студентка института лингвистики Российского государственного гуманитарного университета",
  " закончила школу с золотой медалью, сдала литературу и английский язык на 100 баллов",
